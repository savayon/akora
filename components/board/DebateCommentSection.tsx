...
export function DebateCommentSection({
  ...
  return (
    <div className="relative mt-8">
      {!userStance && (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-slate-50/40 backdrop-blur-[3px] rounded-2xl">
          <div className="bg-slate-900/95 text-white px-8 py-8 rounded-3xl shadow-2xl flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-300 mx-4 border border-slate-700/50 sticky top-40">
